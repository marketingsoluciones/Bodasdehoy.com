    ...
    return (
        <div className="w-full">
            <div
             ...
             className="text-gray-300 p-3 bg-base rounded-xl flex items-center justify-between cursor-pointer hover:bg-gray-100 transition">
            <h2 className={`${isOpen ? "text-gray-300" : "text-gray-200"}`}>{title}</h2>
