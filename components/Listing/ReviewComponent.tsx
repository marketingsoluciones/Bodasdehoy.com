...
const AverageComponent: FC = () => {
  return (
    <div className="w-full flex flex-col items-center text-gray-200 py-6 gap-1 md:border-r border-tertiary">
  ...
  const RatingAndRole: FC = () => {
    return (
      <div className="w-full flex items-center justify-start">
        ...
        <p className="ml-2 pl-2 border-l border-gray-100 text-sm text-gray-200">
