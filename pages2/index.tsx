...
const Home: FC<propsHome> = ({ business, categories: categoriesData }) => {
  ...
  const [categories, setCategories] = useState<[{categorie : category, subCategories : [category]}] | []>(categoriesData)
  ...
  return (
    <section className="w-full">
      ...
      <PlaceDiscovery category={categories?.find(item => item.categorie.title.toLowerCase() === "lugares para bodas")} />
